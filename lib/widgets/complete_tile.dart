 ...
 * Make sure that if they do a survey twice its in the history twice
 * 
 */
...
class CompleteSurveyTile extends StatelessWidget {
  ...
  const CompleteSurveyTile({Key? key, required this.survey, required this.index}) : super(key: key);
